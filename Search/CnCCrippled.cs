...
namespace impl_search.Search
{
    public class CnCCrippled
    {
        ...
        // public Dictionary<Location, int> steps = new Dictionary<Location, int>();
        public List<(Location loc, int type)> steps = new List<(Location, int)>();
        ...
        public CnCCrippled(SquareGridDiagonal graph, Location start, Location goal)
        {
			...
			*/
				...
				*/
				        ...
				        */
                        ...
                        // foreach (var p in pleft) { steps.Add((p.Key, 2)); }
                        ...
                        // foreach (var p in pright) { steps.Add((p.Key, 2)); }
